...
hi Conditional ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
hi Constant ctermfg=62 ctermbg=NONE cterm=NONE guifg=#6c71c4 guibg=NONE gui=NONE
hi Define ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
hi DiffAdd ctermfg=231 ctermbg=64 cterm=NONE guifg=#ecf0f1 guibg=#44800a gui=bold
...
hi DiffText ctermfg=231 ctermbg=40 cterm=NONE guifg=#ecf0f1 guibg=#00df00 gui=bold
...
hi Keyword ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
...
hi Operator ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
hi PreProc ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
...
hi rubyConstant ctermfg=68 ctermbg=NONE cterm=NONE guifg=#3498db guibg=NONE gui=bold
...
hi rubyInclude ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
...
hi rubyControl ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
hi rubyClassVariable ctermfg=172 ctermbg=NONE cterm=NONE guifg=#e67e22 guibg=NONE gui=NONE
hi rubyOperator ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
hi rubyException ctermfg=167 ctermbg=NONE cterm=NONE guifg=#e74c3c guibg=NONE gui=bold
hi rubyPseudoVariable ctermfg=172 ctermbg=NONE cterm=NONE guifg=#e67e22 guibg=NONE gui=NONE
hi rubyRailsUserClass ctermfg=68 ctermbg=NONE cterm=NONE guifg=#3498db guibg=NONE gui=bold
